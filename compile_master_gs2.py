...
institute_files = {
    ...
    "Rau IAS": os.path.join(solved_dir, "gs2_rau_ias.md"),
...
def compile_master_file(institute_data):
    ...
    master_output_path = os.path.join(solved_dir, "master_gs2_solved.md")
...
def main():
    ...
    print("\nStarting compilation of master GS2 paper...")
    compile_master_file(institute_data)
    
    print("\nMaster GS2 compilation complete!")
