...
institute_files = {
    ...
    "Rau IAS": os.path.join(solved_dir, "gs3_rau_ias.md"),
...
def compile_master_file(institute_data):
    ...
    master_output_path = os.path.join(solved_dir, "master_gs3_solved.md")
...
def main():
    ...
    print("\nStarting compilation of master GS3 paper...")
    compile_master_file(institute_data)
    
    print("\nMaster GS3 compilation complete!")
