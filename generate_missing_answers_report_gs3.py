...
# Base Directories
syllabus_dir = r"C:\Users\Dr. Yogesh\Desktop\mains\neet and upsc cms\upsc\syllabus hierarchy\gs3"
solved_dir = r"C:\Users\Dr. Yogesh\Desktop\mains\neet and upsc cms\upsc\solved paper\gs3"

institute_files = {
    "Civilsdaily": os.path.join(solved_dir, "gs3_civilsdaily.md"),
    "Drishti IAS": os.path.join(solved_dir, "gs3_drishti_ias.md"),
    "PWOnlyIAS": os.path.join(solved_dir, "gs3_pwonlyias.md"),
    "Superkalam": os.path.join(solved_dir, "gs3_superkalam.md"),
    "Unacademy": os.path.join(solved_dir, "gs3_unacademy.md")
}
...
def main():
    ...
    clean_syllabus_path = os.path.join(syllabus_dir, "GS3_Syllabus_Questions_Formatted.md")
    ...
    run = title.add_run("UPSC Mains GS3: Coaching Institutes Solved Answers Audit")
    run.font.name = "Arial"
    run.font.size = Pt(18)
    run.bold = True
    ...
    p_desc.add_run("This report identifies the presence or absence of solved answers from 5 coaching institutes (Civilsdaily, Drishti IAS, PWOnlyIAS, Superkalam, and Unacademy) for all GS3 syllabus questions spanning Indian Economy, Agriculture, Science and Technology, Environment, Disaster Management, and Internal Security.")
    ...
    # Save document
    output_path = os.path.join(solved_dir, "gs3_missing_answers_report.docx")
    try:
        doc.save(output_path)
        print(f"Successfully generated and saved audit report to: {output_path}")
    except PermissionError:
        output_path_alt = os.path.join(solved_dir, "gs3_missing_answers_report_updated.docx")
